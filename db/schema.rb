...
ActiveRecord::Schema.define(version: 20140125224204) do
  ...
  create_table "completed_projects_users", id: false, force: true do |t|
    t.integer "user_id"
  ...
  create_table "users", force: true do |t|
    ...
    t.string   "first_name",             default: "Joe",     null: false
    t.string   "last_name",              default: "Smith",   null: false
    t.integer  "grade"
